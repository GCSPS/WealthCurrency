...
int64 nChainStartTime = 1465355842;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "WealthCurrencyCoin is a good coins";
        CTransaction txNew;
		...
		block.print();
        assert(block.hashMerkleRoot == uint256("0xcc6457e083d284d51046cc4368f40e898e420126f43d698e8cccc8ba38afa690"));
